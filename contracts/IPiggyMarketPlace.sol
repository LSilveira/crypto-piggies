...
/*
 * Market place to trade piggies (should **in theory** be used for any ERC721 token)
 * It needs an existing Piggy contract to interact with
 * Note: it does not inherit from the Piggy contracts
...
interface IPiggyMarketPlace {
    ...
    * Requirement: Only the contract owner can call.
     */
    function setPiggyContract(address _piggyContractAddress) external;
    ...
    * Requirement: There must be an active offer for _tokenId
     */
    function buyPiggy(uint256 _tokenId) external payable;
}